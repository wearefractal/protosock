...
(function() {
  ...
  if (isBrowser) {
    ...
    options.port = (window.location.port.length > 0 ? parseInt(window.location.port) : 80);
...
});require.register("Server.js", function(module, exports, require, global){
// Generated by CoffeeScript 1.3.3
(function() {
  var Server, engineServer, isBrowser, util,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

  util = require('./util');

  if (isBrowser = util.isBrowser()) {
    throw 'ProtoSock server wis not for the browser';
  }
  ...
  Server = (function() {
    ...
    function Server(plugin) {
      ...
      var eiopts, k, v, _ref, _ref1, _ref2, _ref3;
      for (k in plugin) {
        v = plugin[k];
        this[k] = v;
      }
      ...
      eiopts = {
        ...
        allowUpgrades: (_ref = this.options.upgrades) != null ? _ref.allow : void 0,
        destroyUpgrade: (_ref1 = this.options.upgrades) != null ? _ref1.destroy : void 0,
        pingTimeout: (_ref2 = this.options.ping) != null ? _ref2.timeout : void 0,
        pingInterval: (_ref3 = this.options.ping) != null ? _ref3.interval : void 0,
        debug: this.options.debug
      };
      this.server = engineServer.attach(this.options.server, eiopts);
      this.server.httpServer = this.options.server;
    ...
    Server.prototype.handleConnection = function(socket) {
      ...
      socket.on('error', function(err) {
        return _this.handleError(socket, err);
      });
      socket.on('close', function(reason) {
        return _this.handleClose(socket, reason);
      });
      return this.connect(socket);
    };

    Server.prototype.handleMessage = function(socket, msg) {
      var _this = this;
      return this.inbound(socket, msg, function(formatted) {
        return _this.validate(socket, formatted, function(valid) {
          if (valid === true) {
            return _this.message(socket, formatted);
          } else if (valid === false) {
            return _this.invalid(socket, formatted);
          }
        });
      });
    };

    Server.prototype.handleError = function(socket, err) {
    ...
    Server.prototype.handleClose = function(socket, reason) {
      return this.close(socket, reason);
    };
...
// Generated by CoffeeScript 1.3.3
(function() {
  var Client, engineClient, isBrowser, util,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
});require.register("defaultServer.js", function(module, exports, require, global){
// Generated by CoffeeScript 1.3.3
(function() {
  var def;
...
(function() {
  ...
  module.exports = {
    ...
    mergePlugins: function() {
      var args, newPlugin, plugin, _i, _len;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      newPlugin = {};
    ...
    isBrowser: function() {
      if (typeof window !== "undefined" && window !== null) {
        return true;
      } else if ((typeof module !== "undefined" && module !== null) && (typeof global !== "undefined" && global !== null) && (typeof process !== "undefined" && process !== null)) {
        return false;
      } else {
...
// Generated by CoffeeScript 1.3.3
(function() {
  var Client, Server, defaultServer, util;
